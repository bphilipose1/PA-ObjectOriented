...
class lumen
{
        ...
        * reset()
            ...
            Each lumen object will have a maximum amount of times it can be sucessfully reset based on its size
        
        * recharge()
            - If lumen object is stable it will allow power to be reset back to the value when initialized originally
        
        * Comparison Overloading Operators: this operator compares the objects current power  

        * Addition Overloading Operators: Allows for client to increase the brightness and power of a lumen object

        * Subtraction Overloading Operators: Was decided to be not needed as the user already is able to decrease power and brightness throught
        other methods thus making this operator overloading redundant and can cause an undetected behavior within the object.

        *Multiplication Overloading Operators: Was decided to be not needed as the user already is able to increment the power by a user inputed value.
        by adding multiplication it would be irrelevent due to the scales of brightness and power not being large enough to warrant it.
        
        */

    private:
        /*
        * Description: Helper function to increase brightness and power by a value
        * PRE: NONE
        * POST: brightness and power will increase by x and 10*x accordingly, dimness will decrease by x
        */
        ...
        */
        ...
        /*
        * Description: Adds onto brightness and Power
        * PRE: No negative inputs.
        * POST: lumen object's brightness and power is updated
        */
        void add(int inpBrig, int inpPow);
    ...
    public:
        ...
        */
        ...
        /*
        DESCRIPTION: Overload the > Comparison operator. Compares both lumens power
        */
        bool operator>(const lumen& src) const;
        ...
        */ 
        ...
        /*
        DESCRIPTION: Overload the + operator. Adds lumens brightnesses and power together.
        PRE: None
        POST: Creates a temporary with the combination of both lumens
        */
        lumen operator+(const lumen& src) const;

        /*
        DESCRIPTION: Overload the += operator. Adds other lumens brightnesses and power together.
        PRE: None
        POST: modifies lumen on left of operator with the combination of both lumens
        */
        lumen& operator+=(const lumen& src);

        /*
        DESCRIPTION: Overload the + operator. increments lumen brightnesses and power by inputed int.
        PRE: None
        POST: Creates a temporary with the combination of both lumen and the input value number 
        */
        lumen operator+(int inputInt) const;

        /*
        DESCRIPTION: Overload the += operator. increments lumen brightnesses and power by inputed int.
        PRE: None
        POST: updates lumen on the left of operator with the the combination of both lumen and the new number of lumen objects
        */
        lumen& operator+=(int inputInt);

        /*
        DESCRIPTION: Overload the prefix ++ operator. Increments 1 to brightness, increments 10 to power
        PRE: None
        POST: increments lumens innerstate by a predefined step
        */
        lumen& operator++();

        /*
        DESCRIPTION: Overload the postfix ++ operator
        PRE: None
        POST: increments lumens innerstate by a predefined step. But returns the previous state.
        */
        lumen& operator++(int);
        ...
        */
        ...
        /*
        * Description: resets IF reset conditions are met. And total amount of sucessful resets are not passed.
        * PRE: NONE
